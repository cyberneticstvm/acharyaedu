...
class StudentController extends Controller
{
    ...
    public function notes(){
        $student = Student::find(Auth::user()->student->id);
        $downloads = Download::leftJoin('download_batches', 'downloads.id', '=', 'download_batches.download_id')->whereIn('download_batches.batch_id', $student->batches->pluck('batch'))->whereNotNull('description')->get();
