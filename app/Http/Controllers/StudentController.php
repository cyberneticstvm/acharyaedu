...
class StudentController extends Controller
{
    ...
    public function examperformance($id){
        if($id > 0):
            ...
            return view('student.performance', compact('exam', 'student'));
        else:
    ...
    public function studymaterials(){
        $subjects = Subject::inRandomOrder()->limit(1)->get(); $modules = Topic::inRandomOrder()->limit(5)->get(); $questions = collect();
        $inputs = [];
    ...
    public function getstudymaterials(Request $request){
        ...
        $subjects = Subject::where('id', $request->subject_id)->get(); $modules = Topic::where('subject_id', $request->subject_id)->get();
