...
Route::group(['middleware' => ['web', 'auth', 'student']], function () {
    ...
    Route::post('/student/update/offline-exams/{id}', [StudentController::class, 'updateOfflineExams'])->name('student.offline.exams.update');
    ...
    Route::get('/student/scert-and-general/options/{id}', [StudentController::class, 'scertAndGeneralQuestionsBySubject'])->name('student.scert.general.questions.by.subject');
});
...
Route::group(['middleware' => ['web', 'auth', 'admin']], function () {
    ...
    Route::delete('/admin/offline/exam/{id}', [ExamController::class, 'offlineExamDelete'])->name('admin.offline.exam.delete');
