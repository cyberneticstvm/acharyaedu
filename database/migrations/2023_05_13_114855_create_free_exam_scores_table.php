...
return new class extends Migration
{
    ...
    {
        Schema::create('free_exam_scores', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('student_exam_id')->references('id')->on('free_student_exams')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('free_exam_scores');
    }
};
