    ...
    <div class="swiper-container-h2">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <!-- rts-banner area end-->
                <div class="rts-section-gap3Top ptb_sm-20 rts-banner-one bg_image" style="background-image: url('/public/storage/sliders/{{ $slider->image }}')">
                    ...
                    <div class="project-inner">
                        <div class="content">
                            ...
                            <a href="service-details.html">
                                <h5 class="title">Sustainable System</h5>
                            </a>
                        </div>
                ...
                <div class="rts-single-project-one">
                    ...
                    <div class="project-inner">
                        <div class="content">
                            ...
                            <a href="service-details.html">
                                <h5 class="title">Property Maintenance</h5>
                            </a>
                        </div>
                        <div class="icon"> <a href="service-details.html"><i class="fa-thin fa-chevron-right"></i></a></div>
                    </div>
                ...
                <div class="rts-single-project-one">
                    ...
                    <div class="project-inner">
                        <div class="content">
                            <p class="pre-title">Service-03</p>
                            <a href="service-details.html">
                                <h5 class="title">Virtual design & build</h5>
                            </a>
                        </div>
                        <div class="icon"> <a href="service-details.html"><i class="fa-thin fa-chevron-right"></i></a></div>
                    </div>
