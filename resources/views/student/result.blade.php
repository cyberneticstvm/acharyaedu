    ...
    <div class="container-fluid">
        <div class="row">
            <div class="mian-wrapper-form">
                <div class="row">
                    <div class="col-md-12 mb-3"><h5 class="text-primary">{{ $student->name }}'s Exam Result</h5></div>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="step-{{$quest->id}}" class="tab-pane quest" role="tabpanel" aria-labelledby="step-{{$quest->id}}">
                                    ...
                                    @forelse($quest->question->options as $key1 => $opt)
                                        ...
                                        @elseif($quest->answer == 0 && $quest->selected_option != NULL)
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <button data-bs-toggle="collapse" data-bs-target="#correctanswer{{$quest->id}}" class="rts-btn btn-primary btnshow">Show Correct Answer</button>
                                            <div class="row">
                                        ...
                                        <div class="col">
                                            <button data-bs-toggle="collapse" data-bs-target="#explanation{{$quest->id}}" class="rts-btn btn-primary btnshow">Show Explanation</button>
                                            <div class="row">
