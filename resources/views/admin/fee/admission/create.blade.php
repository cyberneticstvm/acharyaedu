    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header pb-0 text-left bg-transparent">
                <h3 class="font-weight-bolder text-primary text-gradient">Create Admission Fee</h3>
            </div>
            <div class="card-body">
                <form role="form" method="post" action="{{ route('admission.fee.save') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    <input type="number" class="form-control" name="amount" min="1" step="1" placeholder="0.00" />
                                </div>
                                @error('fee')
