                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    <select class="form-control" name="batch">
                                        ...
                                        <option value="{{ $bat->batch }}">{{ $bat->batchh->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    <input type="number" class="form-control" name="fee_advance" min="1" step="1" value="{{ old('fee_advance') }}" placeholder="0.00" required />
                                </div>
                                @error('fee_advance')
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="mb-3">
                                    <input type="number" class="form-control" name="fee_balance" step="any" value="{{ old('fee_balance') }}" placeholder="0.00" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-2">
