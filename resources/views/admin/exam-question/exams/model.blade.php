<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            <label class="req mb-1">Questions From</label>
            <select class="form-control" name="questions_from" data-random="0">
                <option value="2">SCERT</option>
                <option value="1">General</option>
            </select>                                  
        </div>
        @error('questions_from')
            <small class="text-danger">{{ $errors->first('questions_from') }}</small>
        @enderror
    </div>
    <div class="col-md-2">
        <div class="form-group">
