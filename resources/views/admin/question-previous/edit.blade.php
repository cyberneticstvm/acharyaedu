    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header pb-0 text-left bg-transparent">
                <h3 class="font-weight-bolder text-primary text-gradient">Update Previous Question</h3>
            </div>
            <div class="card-body">
                <form role="form" method="post" action="{{ route('previousquestion.update', $question->id) }}">
                    @csrf
                    @method("PUT")
                    <div class="row">               
                        <div class="col-md-3">
