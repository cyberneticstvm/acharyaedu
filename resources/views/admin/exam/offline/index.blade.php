    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card">
            <div class="card-header pb-0 text-left bg-transparent">
                <div class="row">
                    <div class="col">
                        <h3 class="font-weight-bolder text-primary text-gradient">Offline Exam Register</h3>
                    </div>
                    <div class="col text-end"><a href="{{ route('admin.offline.exam.create') }}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">CREATE</a></div>
                </div>
                <div class="row">
                    <div class="col-md-4">
